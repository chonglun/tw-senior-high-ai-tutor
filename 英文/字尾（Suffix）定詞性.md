---
科目: 英文
主題: 字尾（Suffixes）與詞性轉換
課綱對應: 英文學測全範圍（工具性能力，跨冊跨題型）
難度: ★★★
考試頻率: 高
標籤: [詞彙, 字根字首字尾, 詞性辨別, 學測詞彙題]
教學風格Agent: 口訣派
檢查狀態: 待人工複核
信心度: 中
更新日期: 2026-06-28
...
graph LR
    %% 核心字根節點
    R(("<b>❤️ 字根 Root</b><br>例: act / happy / create"))
    style R fill:#ff9999,stroke:#c62828,stroke-width:2px;

    %% 詞性字尾分流
    N["<b>📝 名詞字尾</b><br>-tion / -ment / -ness / -ity<br>-er / -or / -ance / -ence"]
    V["<b>🎬 動詞字尾</b><br>-ize / -ify / -en / -ate"]
    ADJ["<b>🎨 形容詞字尾</b><br>-able / -ible / -ous / -ious<br>-al / -ful / -less / -ive"]
    ADV["<b>⚡ 副詞字尾</b><br>-ly<br>提醒: 幾乎只加在形容詞後"]

    style N fill:#e1f5fe,stroke:#0288d1,stroke-width:2px;
    style V fill:#f3e5f5,stroke:#8e24aa,stroke-width:2px;
    style ADJ fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px;
    style ADV fill:#fff3e0,stroke:#f57c00,stroke-width:2px;

    %% 實例輸出節點
    EX1["<b>📦 名詞實例</b><br>action / happiness<br>agreement / creativity"]
    EX2["<b>📦 動詞實例</b><br>modernize / simplify<br>widen / create"]
    EX3["<b>📦 形容詞實例</b><br>readable / famous<br>national / careful"]
    EX4["<b>📦 副詞實例</b><br>carefully / happily<br>actively / obviously"]

    style EX1 fill:#fff9c4,stroke:#fbc02d,stroke-width:1px,stroke-dasharray: 3 3;
    style EX2 fill:#fff9c4,stroke:#fbc02d,stroke-width:1px,stroke-dasharray: 3 3;
    style EX3 fill:#fff9c4,stroke:#fbc02d,stroke-width:1px,stroke-dasharray: 3 3;
    style EX4 fill:#fff9c4,stroke:#fbc02d,stroke-width:1px,stroke-dasharray: 3 3;
...
- [字首（Prefix）定方向](字首（Prefix）定方向.md)
